...
export default function Home() {
	return (
		<div>
			<Head>
				<title>Playhouse Media - Home</title>
				<meta
					name='description'
					content='Playhouse Media Is An Award-Winning Digital Marketing Agency. We offer your Business the chance to build a Successful Digital Marketing Strategy'
				/>
